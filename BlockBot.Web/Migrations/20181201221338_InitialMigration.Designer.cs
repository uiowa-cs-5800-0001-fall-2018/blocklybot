...
namespace BlockBot.Web.Migrations
{
    ...
    [Migration("20181201221338_InitialMigration")]
            ...
            modelBuilder.Entity("BlockBot.Common.Data.ProjectSettingType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("2078335c-4dea-48e6-8248-1c9cee3f1a1b"), AllowsMany = false, Name = "AwsAccessKey" },
                        new { Id = new Guid("2e10e0a3-f121-4b3b-a80d-2bad25e58064"), AllowsMany = false, Name = "AwsSecretKey" },
