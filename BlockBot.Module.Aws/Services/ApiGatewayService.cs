...
namespace BlockBot.Module.Aws.Services
{
    public class ApiGatewayService : IApiGatewayService
    {
        ...
        public async Task<ApiGatewayResourceDelete> DeleteResourceMappedToLambda(string restApiId, string resourceName)
        {
            try
            {
                ...
                {
                    throw new Exception($"Could not calculate resource id for API Gateway resource name '{resourceName}' on Rest API id '{restApiId}'.");
                }
