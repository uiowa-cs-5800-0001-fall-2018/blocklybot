...
namespace BotBuilder.Tests.AwsServicesTests
{
    ...
    public class LambdaServiceTests
    {
        ...
        private static string bucket = "harley-waldstein-test-lambda-bucket";
        private static string key = "text-deploy.zip";
        ...
        public static void ClassInitialize(TestContext testContext)
        {
            ...
            string fileContents = "exports.handler = async (event) => {\n    // TODO implement\n    const response = {\n        statusCode: 200,\n        body: JSON.stringify(\'Hello from Lambda!\')\n    };\n    return response;\n};"; //here is your file in bytes
            ...
            using (MemoryStream outStream = new MemoryStream())
            {
                ...
                bool objectCreateSucceeded = _s3Service.CreateOrUpdateObject(bucket, key, outStream, S3CannedACL.PublicRead).Result;
            }
        }
        ...
        {
            string a = _lambdaService.CreateLambda("unit-test-function", "TODO", "arn:aws:iam::687311858360:role/service-role/fundamentals_chatbot", bucket, key).Result;
            int b = 0;
        }
    }
}
